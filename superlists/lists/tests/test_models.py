...
class ListModelTest(TestCase):
    ...
    def test_add_email_to_shared_with_user(self):
        """test: добавление пользователя в список поделиться с пользователем"""

        user = User.objects.create(email="friend@email.com")
